...
if ( is_admin() ){
	...
	<form action="" method="POST">
		...
		<br/><br/>SUFFIXES: (NOTE: Once you build a website, and google indexes your site, then dont change this value, or your site will loose all pages+ranking indexed!)
		...
		<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; For example, when you publish "eng" language posts, their link will be like: <?php echo homeURL__MLSS;?>/eng/<b>the-last-holidays-i-spent...</b>, but for categories: <?php echo homeURL__MLSS;?>/eng_<b><?php echo get_option('optMLSS__CategSlugname');?></b>/automobiles/mercedes
		<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
