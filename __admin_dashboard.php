...
if ( is_admin() ){
	...
	function my_submenu1__MLSS() { 
		...
		<div class="eachBlock">
			...
			<br/><br/>*<b>Conditional Widgets</b> - For example, you want that different widgets were displayed in different language directories.. You have two methods:
			<br/> -A) Add special ClassNames to individual widgets (<a href="javascript:alert('That field is now visible on any widget. If it appears not to work on a certain widget, that widget probably breaks WordPress Widgets API rules somehow...\r\n\r\n\r\n (p.s. Thanks to Author of \u0022SIMPLE WIDGET CLASSES and WIDGET ATTRIBUTES\u0022.) ');" class="readpopp">Read this popup</a>!)-   &nbsp;&nbsp;&nbsp; Add this phrase in widget's Classname field: <span class="codee">MLSS_widget_<span style="color:red;">eng</span></span>, and so on.. AND, for example, within English directories, all other <span class="codee">MLSS_widget_<span style="color:red;">xxx</span></span> widgets wont be displayed!
