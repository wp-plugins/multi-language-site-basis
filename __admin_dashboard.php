...
if ( is_admin() ){
	...
	function my_submenu1__MLSS() { 
		...
		<div class="eachBlock">
			...
			<br/>(p.s. To upload your <a href="https://ps.w.org/multi-language-site-basis/assets/unused_flags.zip" target="_blank">flag</a> for your inserted language, then <i><a href="javascript:alert('As mentioned above, you should use 3 official symbols as a name of your flag image. For example: eng.png, rus.png, fra.png .... Also, the image dimensions could be approximately 128px. And you should upload that in this directory: <?php echo dirname(plugin_dir_url(__FILE__));?>/flags ');" class="readpopp">Read popup!</a></i>)
			<br/>
		...
		<div class="eachBlock">
			<span class="fakeH22"> 3) On-site Dropdown Settings </span> (<a href="javascript:alert('you will see the DROPDOWN menu in the UPPER CORNER of your site.. ');" class="readpopp"><i>Read popup</i></a>!):
