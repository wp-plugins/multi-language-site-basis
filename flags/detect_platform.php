...
function get_user_browser(){	$b = $_SERVER['HTTP_USER_AGENT'];
	...
	//if typical browsers
	elseif(preg_match('/Firefox/i',$b))		{$k = "Firefox";	}
	elseif(preg_match('/Safari/i',$b))		{$k = "Safari";	}
	elseif(preg_match('/Chrome/i',$b))		{$k = "Chrome";	}
	elseif(preg_match('/Flock/i',$b))		{$k = "Flock";		}
	elseif(preg_match('/Opera/i',$b))		{$k = "Opera";		}
			elseif(preg_match('/MSIE 6/i',$b))				{$k = "MSIE 6";	}
			elseif(preg_match('/MSIE 7/i',$b))				{$k = "MSIE 7";	}
			elseif(preg_match('/MSIE 8/i',$b))				{$k = "MSIE 8";	}
			elseif(preg_match('/MSIE 9/i',$b))				{$k = "MSIE 9";	}
			elseif(preg_match('/MSIE 10/i',$b))				{$k = "MSIE 10";	}
			elseif(preg_match('/Trident\/7.0; rv:11.0/',$b)){$k = "MSIE 11";	}
	else													{$k = "UNKNOWNNN";	}
	//===========================================================================================================
